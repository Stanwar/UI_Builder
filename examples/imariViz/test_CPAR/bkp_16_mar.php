...
<div style="float:left"><img width="50px" height="50px" src="../CRI_Small.png"></div>
          <a class="navbar-brand" href="https://login.cri.uic.edu/index.php">&nbspCRI</a>
	  <a class="navbar-brand" href="https://login.cri.uic.edu/projects.html">CHECK - Project</a>
          <a class="navbar-brand" href="https://login.cri.uic.edu/SpagoBISDK/index.jsp">CHECK Metrics</a>
        </div>
				...
				<ul class="list-unstyled">
					...
					<li><h4> <label title="{{Map_Label}}">Map Controls </label></h4></li>
						...
						<div class="btn-group" ng-click="change()">
							...
							<label class="btn btn-success" ng-model="heatMapModel" uib-btn-radio="'Patient_Charges'" ng-disabled="disableCheck">Patient_Utilization</label>
        ...
        <div class="col-xs-7 col-sm-3 col-md-3 sidebar sidebar-right sidebar-animate">
			<div>
				<ul class="list-unstyled">
					...
					<button class="btn btn-default" type="submit" onclick="window.open('../checkVizAngular/data/readme.txt')">Download!</button>
					<!--<label class="btn btn-default" ><a href="../checkVizAngular/data/" download="readme.txt">Download Readme File</a></label>-->
					...
					<li><h4>Table Legend</h4></li>
						<ul>
							<li> Zip - Zip </li>
							<li> Age </li> 
							<li> Dis Enc - Disease Encounter</li>
							<li> Total Enc - Total Patient Encounter</li> 
							<li> Total Cost - Total Patient Cost</li> 
							<li> ASA - Asthma</li> 
							<li> DIA - Diabetes</li>
							...
							<li> IP Cost - IP Cost</li>
							<li> IP Enc - IP Encounters</li>
							<li> OP Cost - OP Cost</li>
							<li> OP Enc - OP Encounters</li>
							<li> NIPS Cost - NIPS Charges</li>
							<li> NIPS Enc - NIPS Encounter</li>
						</ul>
				</ul>
			</div>
        </div>
