			...
			<div>
				...
				<ul class="list-unstyled">
					...
					<!-- 	<label class="btn btn-primary" ng-model="sourceInitialModel" uib-btn-radio="'Total'">Total</label>
						...
						<label ng-repeat="name in Sources" class="btn btn-primary" ng-model="sourceInitialModel.Sources" ng-value="name.name"
						uib-btn-radio="name.name">{{name.name}}</label>
						  <!-- 
						<label class="btn btn-primary" ng-model="sourceInitialModel" uib-btn-radio="'UIHP'">UIHP</label>
						<label class="btn btn-primary" ng-model="sourceInitialModel" uib-btn-radio="'Harmony'">Harmony</label> -->
					...
					<div class="btn-group" ng-click="change()">
						...
						<label ng-repeat="name in Views" class="btn btn-primary" ng-model="sourceRadioModel.Views" ng-value="name.view_name"
					...
					<li><h4> <label title="{{Encounter_Label}}">Encounters</label> </h4></li>
						<input type="text" id="binSize" class="form-control" ng-model="binDivide"> <label class="btn btn-default" ng-click="change()" title="Maximum 10 bins">Change Bin</label>
						<div class="btn-group" ng-click="change()">
							<!--<label class="btn btn-primary" ng-model="checkModel.ALL" uib-btn-checkbox>ALL</label>-->
							<label class="btn btn-primary" ng-model="checkModel.IP" uib-btn-checkbox uncheckable  ng-disabled="disableCheck">IP</label>
							<label class="btn btn-primary" ng-model="checkModel.OP" uib-btn-checkbox uncheckable  ng-disabled="disableCheck"> OP</label>
							<label class="btn btn-primary" ng-model="checkModel.NIPS" uib-btn-checkbox uncheckable  ng-disabled="disableCheck">NIPS</label>
						</div>

						<div class="btn-group" ng-click="filterChange()">
					...
					<li><h4> <label title="{{Disease_Label}}">Diseases </label></h4></li>
						<div class="btn-group" ng-click="change()" >
			...
			<div>
				<ul class="list-unstyled">
					...
					<li><h4>Table Legend</h4></li>
						<ul>
							<li> Zip - Zip </li> 
							<li> DE - Disease Encounter</li>
							<li> TPE - Total Patient Encounter</li> 
							<li> A - Asthma</li> 
							<li> D - Diabetes</li>
							<li> S - Sickle Cell Disease</li>
							<li> P - Prematurity</li>
							<li> E - Epilepsy</li>
							<li> N - NewbornInjury</li>
							<li> IPC - IP Charges</li>
							<li> IPE - IP Encounters</li>
							<li> OPC - OP Charges</li>
							<li> OPC - OP Charges</li>
							<li> NIPSC - NIPS Charges</li>
							<li> NIPSE - NIPS Encounter</li>
						</ul>
				</ul>
			</div>
        </div>
