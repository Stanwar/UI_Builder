				...
				<ul class="list-unstyled">
 					<li><b> <label title="{{Map_Label}}">Map Controls </label></b></li>
                                                <div class="btn-group" ng-click="change()">
                                                        <div>
                                                             	<b> <span  style="padding-top:5px; padding-bottom:3px; padding-left:5px"><input type="radio" ng-model="heatMapModel"
...
value="Patient_Charges"> Patient_Charges </li></b>
					...
					<div class="btn-group">
						<div ng-click="change()" ng-repeat="name in Sources">						  
							<h5> <span  style="padding-top:5px; padding-bottom:3px; padding-left:5px"><input type="radio" ng-model="sourceInitialModel.Sources" name={{name.name}} value={{name.name}} title={{name.title}}> {{name.name}}</h5>
						</div>
					</div>
					...
					<li><b><label>Service Categories</label> </b></li>
						<div class="btn-group" ng-click="change()">
							<h5>
							 <span  style="padding-top:5px; padding-bottom:15px; padding-left:5px"><input type="checkbox" ng-model="checkModel.IP" uncheckable  ng-disabled="disableCheck" title="Inpatient"> IP </span>
							 <span  style="padding-top:5px; padding-bottom:15px; padding-left:5px"><input type="checkbox" ng-model="checkModel.OP" uncheckable  ng-disabled="disableCheck" title="Outpatient"> OP </span>
							 <span  style="padding-top:5px; padding-bottom:15px; padding-left:5px"><input type="checkbox" ng-model="checkModel.NIPS" uncheckable  ng-disabled="disableCheck" title="Non-Institutional Provider Services (OutPatient or Third Party)"> NIPS </span>
							 <span  style="padding-top:5px; padding-bottom:15px; padding-left:5px"><input type="checkbox" ng-model="checkModel.ED" uncheckable  ng-disabled="disableCheck" title="Emergency Department"> ED </span>
							 <span  style="padding-top:5px; padding-bottom:15px; padding-left:5px"><input type="checkbox" ng-model="checkModel.MEDICARE" uncheckable  ng-disabled="disableCheck" title="Emergency Department"> MEDICARE </span>
							</h5>
					...
					<label class="btn btn-default" ng-click="change()" title="Maximum 10 bins">Change Bin</label>
							<input type="text" id="binSize" class="form-control" ng-model="binDivide">
						<br> -->
